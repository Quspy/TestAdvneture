...
public class BT11111_FIGHT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bt11111_fight);
    ...
    public void OptionOne(View v)
    {
        ...
        if(weaponID!=null)
        {
            Intent intent = new Intent(this,BT111111.class);
            intent.putExtra(EXTRA_MESSAGE,name);
            startActivity(intent);
            finish();
        }
        ...
        {
            Intent intent = new Intent(this,BR111111_LOSE.class);
            intent.putExtra(EXTRA_MESSAGE,name);
            startActivity(intent);
            finish();
        }
