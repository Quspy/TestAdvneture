...
public class BT12211_FIGHT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bt12211_fight);
    ...
    public void OptionOne(View v)
    {
        ...
        if(weaponID!=null)
        {
            Intent intent = new Intent(this,BT12211_WON.class);
            intent.putExtra(EXTRA_MESSAGE,name);
            startActivity(intent);
            finish();
        }
        ...
        {
            Intent intent = new Intent(this,BT12211_LOSE.class);
            intent.putExtra(EXTRA_MESSAGE,name);
            startActivity(intent);
            finish();
        }
