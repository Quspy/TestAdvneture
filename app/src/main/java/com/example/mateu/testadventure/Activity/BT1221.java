...
public class BT1221 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bt1221);
    ...
    {
        Intent intent = new Intent(this, BT11212_DIE.class);
        intent.putExtra(EXTRA_MESSAGE,name);
        startActivity(intent);
        finish();
    }
    ...
    {
        Intent intent = new Intent(this,BT12211_FIGHT.class);
        intent.putExtra(EXTRA_MESSAGE,name);
        startActivity(intent);
        finish();
    }
    ...
    {
        Intent intent = new Intent(this,BT12212_SNEAK.class);
        intent.putExtra(EXTRA_MESSAGE,name);
        startActivity(intent);
        finish();
    }
