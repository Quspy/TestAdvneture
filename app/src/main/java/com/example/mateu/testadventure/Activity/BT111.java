...
public class BT111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bt111);
    ...
    {
        Intent intent = new Intent(this,BT1111_DIE.class);
        intent.putExtra(EXTRA_MESSAGE,name);
        startActivity(intent);
        finish();
    }
    ...
    {
        Intent intent = new Intent(this,BT1112_ITEM.class);
        intent.putExtra(EXTRA_MESSAGE,name);
        startActivity(intent);
        finish();
    }
    ...
    {
        Intent intent = new Intent(this,BT1113.class);
        intent.putExtra(EXTRA_MESSAGE,name);
        startActivity(intent);
        finish();
    }
